...
<!--
Adapted from the Astral team's AI policy
(https://github.com/astral-sh/.github/blob/main/AI_POLICY.md), used under the MIT
license. All credit to the Astral team.
-->
